          ...
          <div className="card-body p-4">
            ...
            <form action="#">
              ...
              <div className="mb-3 justify-content-between d-flex">
                ...
                <Link to="pages-authentication-forgot-password.html" className="text-info ml-1">Forgot your password?</Link>
              </div>
              ...
              <Link to="#" className="btn btn-facebook btn-block mb-4"><span className="mr-2"><i className="fab fa-facebook-f"></i></span> Sign In with Facebook</Link>
              <Link to="#" className="btn btn-twitter  btn-block mb-4"><span className="mr-2"><i className="fab fa-twitter"></i></span> Sign In with Twitter</Link>
            </form>
          </div>
        </div>
        <div className="row mt-3">
          <div className="col-12 text-center">
            <p className="text-muted">Don't have an account? <Link to="pages-authentication-register.html" className="text-info ml-1">Sign Up</Link></p>
          </div>
        </div>
      </div>
    </div>
