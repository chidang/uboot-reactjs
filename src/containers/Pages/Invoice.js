...
<nav aria-label="breadcrumb">
  ...
  <div className="d-flex header justify-content-between mb-4">
    <h1 className="header-title h3">
      ...
      Invoice <sup className="badge bg-primary fw-300 fs-xs">NEW</sup>
    </h1>
  </div>
          ...
          <table className="table mt-5">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td className="text-right">$2,149.00</td>
                <td className="text-center">1</td>
                <td className="text-right">$2,149.00</td>
              </tr>
              <tr>
                <td className="text-center fw-700">4</td>
                <td className="text-left">Razer Kraken X Ultralight Gaming Headset</td>
