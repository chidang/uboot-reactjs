    ...
    <div className="row">
        <div className="col-md-6">
            ...
            <div className="card-header justify-content-between">
                ...
                <a className="btn btn-warning" data-toggle="collapse" data-target="#cardBoostrapCheckbox" role="button" aria-expanded="false" aria-controls="cardBoostrapCheckbox"><i className="dripicons-minus" /></a>
            ...
            <div className="card-header justify-content-between">
                ...
                <div className="card-widgets">
                <a className="btn btn-success" href="javascript:;" data-action="fullscreen"><i className="bi-fullscreen" /></a>
                <a className="btn btn-warning" data-toggle="collapse" data-target="#cardCustomCheckbox" role="button" aria-expanded="false" aria-controls="cardCustomCheckbox"><i className="dripicons-minus" /></a>
                <a className="btn btn-danger" href="#" data-toggle="remove"><i className="bi-x" /></a>
                </div>
            </div>
            <div id="cardCustomCheckbox" className="card-body show">
                ...
                <div className="form-group">
                    ...
                    <div className="custom-switcher custom-switcher-info">
                        <input type="checkbox" name="custom-switcher-3" id="custom-switcher-3" defaultChecked defaultValue={1} />
                        <label htmlFor="custom-switcher-3" />
                    </div>
                    <div className="custom-switcher custom-switcher-danger">
                        <input type="checkbox" name="custom-switcher-4" id="custom-switcher-4" defaultChecked defaultValue={1} />
                        <label htmlFor="custom-switcher-4" />
                    </div>
                    <div className="custom-switcher custom-switcher-warning">
                        <input type="checkbox" name="custom-switcher-5" id="custom-switcher-5" defaultChecked defaultValue={1} />
                        <label htmlFor="custom-switcher-5" />
                    </div>
                    <div className="custom-switcher">
                        <input type="checkbox" name="custom-switcher-6" id="custom-switcher-6" defaultChecked defaultValue={1} disabled />
        ...
        <div className="col-md-6">
            ...
            <div className="card-header justify-content-between">
                ...
                <div className="card-widgets">
                <a className="btn btn-success" href="javascript:;" data-action="fullscreen"><i className="bi-fullscreen" /></a>
                <a className="btn btn-warning" data-toggle="collapse" data-target="#cardColorOption" role="button" aria-expanded="false" aria-controls="cardColorOption"><i className="dripicons-minus" /></a>
                <a className="btn btn-danger" href="#" data-toggle="remove"><i className="bi-x" /></a>
                </div>
            </div>
