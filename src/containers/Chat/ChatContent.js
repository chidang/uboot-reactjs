    ...
    <div className="chatbox card">
        <div className="card-body p-0">
            <div className="chatbox-header d-flex justify-content-between align-items-center p-3">
                ...
                <span className="user-avatar user-avatar-xs user-avatar-success mr-3">
            ...
            <div className="position-relative">
                <div className="chatbox-body custom-scroll p-3">
                    <div className="d-flex mt-3 d-inline-block">
                        ...
                        <div className="widget-chat-message-left ml-2 px-3 py-2 text-left mw-75">Hi</div>
                    </div>
                    <div className="d-flex mt-3 justify-content-end">
                        <div className="widget-chat-message-right mr-2 px-3 py-2 text-left d-inline-block">Hi</div>
                        <img className="rounded-circle" style={{height: "30px"}} src={maleAvatar} alt="User" />
                    </div>
                    <div className="d-flex mt-3 d-inline-block">
                        <img className="rounded-circle" style={{height: "30px"}} src={avatar} alt="User" />
                        <div className="widget-chat-message-left ml-2 px-3 p-2 text-left">
                    ...
                    <div className="d-flex mt-3 justify-content-end">
                        <div className="widget-chat-message-right mr-2 px-3 p-2 text-left d-inline-block">
                            <p>Lorem ipsum dolor sit amet</p>
                            <p>Consectetur adipiscing elit.</p>
                            <p>Mauris condimentum, nulla ut vulputate sodales</p>
                        </div>
                    ...
                    <div className="d-flex mt-3 d-inline-block">
                        <img className="rounded-circle" style={{height: "30px"}} src={avatar} alt="User" />
                        <div className="widget-chat-message-left ml-2 px-3 p-2 text-left">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mauris condimentum, nulla ut vulputate sodales</div>
                    </div>
                    <div className="fw-600 fs-sm text-center my-3 py-2">Aug 15, 2020, 4:24 PM</div>
                    <div className="d-flex mt-3 justify-content-end">
                        <div className="widget-chat-message-right mr-2 px-3 p-2 text-left d-inline-block">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mauris condimentum, nulla ut vulputate sodales</div>
                        <img className="rounded-circle" style={{height: "30px"}} src={maleAvatar} alt="User" />
                    </div>
                    <div className="d-flex mt-3 d-inline-block">
                        <img className="rounded-circle" style={{height: "30px"}} src={avatar} alt="User" />
                ...
                <div className="chatbox-footer p-3 d-flex">
                    <div className="d-flex w-100 align-items-center justify-content-between mt-2">
                        ...
                        <div><button className="btn btn-primary ml-2 px-6" type="button">Send</button></div>
                    </div>
                </div>
                <div className="chatbox-friend-list custom-scroll position-absolute pos-top pos-bottom p-2">
                    <div className="mt-3 text-gray-300">
                        <div className="chatbox-search-btn h3 m-0 d-flex justify-content-center flex-column pl-2 mt-2"> </div>
                    ...
                    <div className="chatbox-friend-list-item align-items-center d-flex flex-row">
                        <div className="my-2">
                            <a href="#">
                                <span className="user-avatar user-avatar-xs user-avatar-success mr-2">
                                    <span className="user-avatar-img rounded-circle" style={{ backgroundImage: "url(" + femaleAvatar + ")", backgroundSize: "cover" }}></span>
                                </span>
                            </a>
                        </div>
