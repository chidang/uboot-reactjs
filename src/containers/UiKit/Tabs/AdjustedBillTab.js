    ...
    return (
        <div className="card">
            ...
            <div id="cardAdjustedBill" className="card-body show">
                <Tabs defaultActiveKey="tabs_7_1" variant="pills">
                    <Tab eventKey="tabs_7_1" title="Active">
                    ...
                    <Tab eventKey="tabs_7_2" title="Link">
                        <div className="tab-pane">
                    ...
                    <Tab eventKey="tabs_7_3" title="Link">
                    ...
                    <Tab eventKey="tabs_7_4" title="Link">
                        <div className="tab-pane">
...
export default AdjustedBillTab;
