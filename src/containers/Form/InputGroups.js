    ...
    <>
        ...
        <div className="header mb-4">
            <h1 className="header-title h3">
                <i className="fab fa-wpforms text-primary" /> Input Group
            </h1>
        </div>
        <div className="row">
            <div className="col-md-6">
                <div className="card">
                    <div className="card-header justify-content-between">
                        ...
                        <div className="card-widgets">
                            ...
                            <Link className="btn btn-warning" data-toggle="collapse" to="#" data-target="#cardInputGroup" role="button" aria-expanded="false" aria-controls="cardInputGroup"><i className="dripicons-minus" /></Link>
                ...
                <div className="card">
                    <div className="card-header justify-content-between">
                        ...
                        <div className="card-widgets">
                            <Link className="btn btn-success" to="#" data-action="fullscreen"><i className="bi-fullscreen" /></Link>
                            <Link className="btn btn-warning" data-toggle="collapse" to="#" data-target="#cardCheckboxAndRadio" role="button" aria-expanded="false" aria-controls="cardCheckboxAndRadio"><i className="dripicons-minus" /></Link>
                            <Link className="btn btn-danger" to="#" data-toggle="remove"><i className="bi-x" /></Link>
                        </div>
                    </div>
                ...
                <div className="card">
                    <div className="card-header justify-content-between">
                        ...
                        <div className="card-widgets">
                            <Link className="btn btn-success" to="#" data-action="fullscreen"><i className="bi-fullscreen" /></Link>
                            <Link className="btn btn-warning" data-toggle="collapse" to="#" data-target="#cardButtonRadio" role="button" aria-expanded="false" aria-controls="cardButtonRadio"><i className="dripicons-minus" /></Link>
                            <Link className="btn btn-danger" to="#" data-toggle="remove"><i className="bi-x" /></Link>
                        </div>
                    </div>
                ...
                <div className="card">
                    <div className="card-header justify-content-between">
                        ...
                        <div className="card-widgets">
                            <Link className="btn btn-success" to="#" data-action="fullscreen"><i className="bi-fullscreen" /></Link>
                            <Link className="btn btn-warning" data-toggle="collapse" to="#" data-target="#cardSegmentedButton" role="button" aria-expanded="false" aria-controls="cardSegmentedButton"><i className="dripicons-minus" /></Link>
                            <Link className="btn btn-danger" to="#" data-toggle="remove"><i className="bi-x" /></Link>
                        </div>
                    </div>
                ...
                <div className="card">
                    <div className="card-header justify-content-between">
                        ...
                        <div className="card-widgets">
                            <Link className="btn btn-success" to="#" data-action="fullscreen"><i className="bi-fullscreen" /></Link>
                            <Link className="btn btn-warning" data-toggle="collapse" to="#" data-target="#cardCustomSelect" role="button" aria-expanded="false" aria-controls="cardCustomSelect"><i className="dripicons-minus" /></Link>
                            <Link className="btn btn-danger" to="#" data-toggle="remove"><i className="bi-x" /></Link>
                        </div>
                    </div>
            ...
            <div className="col-md-6">
                <div className="card">
                    <div className="card-header justify-content-between">
                        ...
                        <div className="card-widgets">
                            <Link className="btn btn-success" to="#" data-action="fullscreen"><i className="bi-fullscreen" /></Link>
                            <Link className="btn btn-warning" data-toggle="collapse" to="#" data-target="#cardSizing" role="button" aria-expanded="false" aria-controls="cardSizing"><i className="dripicons-minus" /></Link>
                            <Link className="btn btn-danger" to="#" data-toggle="remove"><i className="bi-x" /></Link>
                        </div>
                    </div>
                ...
                <div className="card">
                    <div className="card-header justify-content-between">
                        ...
                        <div className="card-widgets">
                            <Link className="btn btn-success" to="#" data-action="fullscreen"><i className="bi-fullscreen" /></Link>
                            <Link className="btn btn-warning" data-toggle="collapse" to="#" data-target="#cardMultipleInputs" role="button" aria-expanded="false" aria-controls="cardMultipleInputs"><i className="dripicons-minus" /></Link>
                            <Link className="btn btn-danger" to="#" data-toggle="remove"><i className="bi-x" /></Link>
                        </div>
                    </div>
                ...
                <div className="card">
                    <div className="card-header justify-content-between">
                        ...
                        <div className="card-widgets">
                            <Link className="btn btn-success" to="#" data-action="fullscreen"><i className="bi-fullscreen" /></Link>
                            <Link className="btn btn-warning" data-toggle="collapse" to="#" data-target="#cardMultipleAddons" role="button" aria-expanded="false" aria-controls="cardMultipleAddons"><i className="dripicons-minus" /></Link>
                            <Link className="btn btn-danger" to="#" data-toggle="remove"><i className="bi-x" /></Link>
                        </div>
                    </div>
                ...
                <div className="card">
                    <div className="card-header justify-content-between">
                        ...
                        <div className="card-widgets">
                            <Link className="btn btn-success" to="#" data-action="fullscreen"><i className="bi-fullscreen" /></Link>
                            <Link className="btn btn-warning" data-toggle="collapse" to="#" data-target="#cardBottonWithDropdown" role="button" aria-expanded="false" aria-controls="cardBottonWithDropdown"><i className="dripicons-minus" /></Link>
                            <Link className="btn btn-danger" to="#" data-toggle="remove"><i className="bi-x" /></Link>
                        </div>
                    </div>
                    <div id="cardBottonWithDropdown" className="card-body show">
                        <form>
                            ...
                            <div className="input-group">
                                <button className="btn btn-outline-secondary dropdown-toggle" type="button" data-toggle="dropdown" aria-expanded="false">Dropdown</button>
                                <ul className="dropdown-menu">
                                    <li><Link className="dropdown-item" to="#">Action before</Link></li>
                                    <li><Link className="dropdown-item" to="#">Another action before</Link></li>
                                    <li><Link className="dropdown-item" to="#">Something else here</Link></li>
                                    <li>
                                        <hr className="dropdown-divider" />
                                    </li>
                ...
                <div className="card">
                    <div className="card-header justify-content-between">
                        ...
                        <div className="card-widgets">
                            <Link className="btn btn-success" to="#" data-action="fullscreen"><i className="bi-fullscreen" /></Link>
                            <Link className="btn btn-warning" data-toggle="collapse" to="#" data-target="#cardCustomFileInput" role="button" aria-expanded="false" aria-controls="cardCustomFileInput"><i className="dripicons-minus" /></Link>
                            <Link className="btn btn-danger" to="#" data-toggle="remove"><i className="bi-x" /></Link>
                        </div>
                    </div>
