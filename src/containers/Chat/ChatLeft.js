    ...
    <div className="card">
        <div className="card-body">
            ...
            <div className="mt-3 text-center">
                <span className="user-avatar user-avatar-lg user-avatar-success mr-3">
            ...
            <div className="custom-scroll" style={{maxHeight: "470px"}}>
                <div className="mt-3">
                    <p className="mt-4 mb-1 d-flex align-items-center"><span className="ml-1 fw-700">Email</span></p>
                    <p>support@teachprod.com</p>
                    <p className="mt-4 mb-1 d-flex align-items-center"><span className="ml-1 fw-700">Phone</span></p>
                    <p>04 555 555</p>
                    <p className="mt-4 mb-1 d-flex align-items-center"><span className="ml-1 fw-700">Location:</span></p>
                    <p>Napa, California(CA), 94559</p>
                    <p className="mt-4 mb-1 d-flex align-items-center"><span className="ml-1 fw-700">Languages:</span></p>
                    <p>English, Spanish</p>
                </div>
                <hr />
                ...
                <ul className="widget-missed-call list-unstyled m-0">
                    <li>
                        <div className="align-items-center d-flex flex-row position-relative show-child-on-hover">
                            ...
                            <div className="ml-3"><span className="m-0 fs-sm">+04224253253234</span></div>
                    ...
                    <li>
                        <div className="align-items-center d-flex flex-row position-relative show-child-on-hover">
                            <div className="my-2"><img className="rounded-circle" style={{height: "40px"}} src={avatar} alt="User" /></div>
                            <div className="ml-3"><span className="m-0 fs-sm">+04284759494984</span></div>
                            <div className="position-absolute pos-right show-on-hover-parent"> </div>
                        </div>
                    </li>
                    <li>
                        <div className="align-items-center d-flex flex-row position-relative show-child-on-hover">
                            <div className="my-2"><img className="rounded-circle" style={{height: "40px"}} src={avatar} alt="User" /></div>
                            <div className="ml-3"><span className="m-0 fs-sm">+04224253235289</span></div>
                            <div className="position-absolute pos-right show-on-hover-parent"> </div>
                        </div>
                    </li>
                    <li>
                        <div className="align-items-center d-flex flex-row position-relative show-child-on-hover">
                            ...
                            <div className="ml-3"><span className="m-0 fs-sm">+04246335365753</span></div>
                            <div className="position-absolute pos-right show-on-hover-parent"> </div>
                        </div>
                    </li>
                </ul>
