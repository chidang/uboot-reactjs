    ...
    return (
        <div className="card">
            ...
            <div id="cardBasicTab" className="card-body show">
                <Tabs defaultActiveKey="tabs_1_1">
                    <Tab eventKey="tabs_1_1" title="Active">
                    ...
                    <Tab eventKey="tabs_1_2" title="Link">
                        <div className="tab-pane">
                    ...
                    <Tab eventKey="tabs_1_3" title="Link">
                    ...
                    <Tab eventKey="tabs_1_4" title="Disabled" disabled>
                        <div className="tab-pane">
